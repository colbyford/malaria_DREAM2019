...
dbutils.fs.cp("file:/databricks/driver/sc1_X_train.pkl", "/mnt/malaria/sc1/arraydata")

pickle.dump(y_train, open( "sc1_y_train.pkl", "wb" ) )
dbutils.fs.cp("file:/databricks/driver/sc1_y_train.pkl", "/mnt/malaria/sc1/arraydata")
