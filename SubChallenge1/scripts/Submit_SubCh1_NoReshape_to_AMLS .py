...
experiment_name = 'automl-malariadream-sc1-noreshape'
# project folder
project_folder = './aml_project/automl-malariadream-sc1-noreshape'
...
"""
import pickle
X_train = pickle.load(open("../data/sc1_noreshape_X_train.pkl", "rb"))
y_train = pickle.load(open("../data/sc1_noreshape_y_train.pkl", "rb"))
...
fitted_model = pickle.load(open("../model/amls_noreshape_model_7-11-19/sc1_noreshape_model.pkl","rb"))

#%%
"""
Predict Test Data
"""
X_test = pickle.load(open("../data/sc1_noreshape_X_test.pkl", "rb"))
